Application Title: CBClientAppFX

Author: Caitlin Bouroncle

Student ID: 007383283

Class: C195, Software II

Student Application V1

cbouron@wgu.edu

2/22/2024

The purpose of this application is to provide a scheduling GUI using JavaFX, connecting to the customer database using mySQL. Specific criteria is provided by the requester to be met. The scenario and requirements are listed below.
...
To run this program, configure mySQL Workbench to access the database and download the specified libraries to the IntelliJ project structure. 

The additional report that I have provided allows for the user to look up appointments by User Id. This way, if a specific user wishes to see the appointments that they are responsible for it is readily available.
